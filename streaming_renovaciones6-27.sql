...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-06-2026 a las 21:02:29
...
--
-- Estructura de tabla para la tabla `backup_vencimientos_20260515_flujotv_cc`
--

CREATE TABLE `backup_vencimientos_20260515_flujotv_cc` (
  `backup_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `backup_vencimientos_20260515_flujotv_cc`
--

INSERT INTO `backup_vencimientos_20260515_flujotv_cc` (`backup_id`, `suscripcion_id`, `usuario_proveedor`, `old_fecha_vencimiento`, `new_fecha_vencimiento`, `respaldo_en`) VALUES
(1, 147, 'Mgtvplusbo211', '2026-05-11', '2026-06-11', '2026-05-15 10:31:38'),
(2, 155, 'akf75', '2026-05-14', '2026-06-14', '2026-05-15 10:31:38'),
(3, 168, 'Brayan2945', '2026-05-28', '2026-05-29', '2026-05-15 10:31:38'),
(4, 187, 'Elluz64', '2026-06-02', '2026-08-02', '2026-05-15 10:31:38'),
(5, 191, 'Andreslr', '2026-05-13', '2026-08-13', '2026-05-15 10:31:38'),
(6, 192, 'Irisabarca', '2026-05-15', '2026-12-15', '2026-05-15 10:31:38'),
(7, 254, '04WILSON', '2026-05-13', '2026-06-13', '2026-05-15 10:31:38');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `backup_vencimientos_20260515_flujotv_disp`
--

CREATE TABLE `backup_vencimientos_20260515_flujotv_disp` (
  `backup_id` int(11) NOT NULL,
  `suscripcion_id` int(11) DEFAULT NULL,
  `usuario_proveedor` varchar(150) DEFAULT NULL,
  `old_fecha_vencimiento` date DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `backup_vencimientos_20260515_flujotv_disp`
--

INSERT INTO `backup_vencimientos_20260515_flujotv_disp` (`backup_id`, `suscripcion_id`, `usuario_proveedor`, `old_fecha_vencimiento`, `new_fecha_vencimiento`, `respaldo_en`) VALUES
(1, 280, 'Fjtvcg957', '2026-04-28', '2026-08-05', '2026-05-15 10:43:15');
...
(278, 'Fjtvgh1048', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(279, 'Fjtvgh1049', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(280, 'Fjtvgh1050', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(281, 'Fjtvgh1051', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(282, 'Fjtvgh1052', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(283, 'Fjtvgh1053', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(284, 'Fjtvcg1032', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(285, 'Fjtvcg1033', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(286, 'Fjtvcg1034', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(287, 'Fjtvcg1035', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56'),
(288, 'Fjtvcg1036', '', 'Importado desde cdsp.xlsx.csv', '2026-05-15 10:55:56');
...
(48, 187, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 16.00, 1.00, 15.00, '2026-05-02 11:59:25'),
(49, 285, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-05-02 11:59:40'),
(50, 140, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 23.00, 1.00, 22.00, '2026-05-02 12:17:55'),
(51, 137, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 21.00, 1.00, 20.00, '2026-05-04 09:44:14'),
(52, 141, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 16.00, 1.00, 15.00, '2026-05-04 17:24:47'),
(53, 189, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-05 10:51:52'),
(54, 128, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 24.00, 1.00, 23.00, '2026-05-06 16:03:13'),
(55, 135, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 19.00, 1.00, 18.00, '2026-05-07 15:20:54'),
(56, 190, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-05-07 15:21:59'),
(57, 146, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 41.00, 1.00, 40.00, '2026-05-07 15:24:30'),
(58, 193, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-15 14:30:56'),
(59, 188, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-16 12:45:11'),
(60, 195, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-16 12:47:53'),
(61, 201, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-19 13:55:14'),
(62, 198, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-05-19 13:57:40'),
(63, 196, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-19 14:14:10'),
(64, 197, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-05-20 11:46:46'),
(65, 157, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 21.00, 1.00, 20.00, '2026-05-21 13:51:39'),
(66, 132, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 16.00, 1.00, 15.00, '2026-05-26 12:48:44'),
(67, 199, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-05-28 11:21:55'),
(68, 158, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 10.00, 1.00, 9.00, '2026-05-28 13:55:25'),
(69, 246, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 23.00, 1.00, 22.00, '2026-05-28 13:55:34'),
(70, 203, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-05-29 10:35:28'),
(71, 208, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 14, 420.00, 216.00, 204.00, '2026-06-01 17:25:51'),
(72, 205, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 36.00, 1.00, 35.00, '2026-06-03 11:09:34'),
(73, 204, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 44.00, 1.00, 43.00, '2026-06-03 11:10:07'),
(74, 186, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 42.00, 1.00, 41.00, '2026-06-03 11:11:39'),
(75, 142, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-06-03 11:12:47'),
(76, 138, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-06-03 11:16:25'),
(77, 137, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 21.00, 1.00, 20.00, '2026-06-03 11:18:13'),
(78, 144, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-06-03 11:19:12'),
(79, 207, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 35.00, 1.00, 34.00, '2026-06-08 14:11:05'),
(80, 143, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 3.00, 1.00, 2.00, '2026-06-08 14:34:43'),
(81, 206, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 39.00, 1.00, 38.00, '2026-06-08 14:43:14'),
(82, 141, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 16.00, 1.00, 15.00, '2026-06-08 14:43:54'),
(83, 140, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 23.00, 1.00, 22.00, '2026-06-08 14:44:27'),
(84, 139, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 42.00, 1.00, 41.00, '2026-06-08 14:47:11'),
(85, 202, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 19.00, 1.00, 18.00, '2026-06-08 14:47:51'),
(86, 148, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 3, 100.00, 54.00, 46.00, '2026-06-08 14:49:41'),
(87, 135, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 19.00, 1.00, 18.00, '2026-06-08 14:50:12'),
(88, 128, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 24.00, 1.00, 23.00, '2026-06-08 16:08:29'),
(89, 168, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 10.00, 1.00, 9.00, '2026-06-08 16:29:09'),
(90, 149, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 40.00, 1.00, 39.00, '2026-06-09 10:44:59'),
(91, 209, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-06-11 10:31:04'),
(92, 174, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 14.00, 1.00, 13.00, '2026-06-11 10:33:42'),
(93, 146, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 41.00, 1.00, 40.00, '2026-06-11 11:29:07'),
(94, 155, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 23.00, 1.00, 22.00, '2026-06-12 17:17:00'),
(95, 254, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 35.00, 18.00, 17.00, '2026-06-12 17:17:48'),
(96, 212, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-06-13 10:10:44'),
(97, 213, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 7, 210.00, 108.00, 102.00, '2026-06-19 13:35:33'),
(98, 157, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 21.00, 1.00, 20.00, '2026-06-23 10:18:59'),
(99, 162, 4, 'Flujo TV (Cuenta Completa)', 'RENOVACION', 1, 18.00, 1.00, 17.00, '2026-06-25 16:24:00');
...
(128, 119, 4, 3, 24.00, 1.00, '2023-12-27', '2026-07-08', 'ACTIVO', NULL, NULL, 'Antonio2945', NULL, 0, '2026-02-24 21:44:17'),
...
(132, 123, 4, 3, 16.00, 1.00, '2024-10-21', '2026-06-26', 'VENCIDO', NULL, NULL, 'TVGUTIERREZ64', NULL, 0, '2026-02-24 21:44:17'),
...
(135, 126, 4, 3, 19.00, 1.00, '2024-06-12', '2026-07-08', 'ACTIVO', NULL, NULL, 'crsirpa', NULL, 0, '2026-02-24 21:44:17'),
(136, 127, 4, 3, 14.00, 1.00, '2024-12-28', '2026-03-01', 'VENCIDO', NULL, NULL, 'VladimirM64', NULL, 1, '2026-02-24 21:44:17'),
(137, 128, 4, 3, 21.00, 1.00, '2024-04-04', '2026-07-04', 'ACTIVO', NULL, NULL, 'MiguelT74', NULL, 0, '2026-02-24 21:44:17'),
(138, 129, 4, 4, 100.00, 54.00, '2024-07-02', '2026-09-03', 'ACTIVO', NULL, NULL, 'Mgtvplusbo613', NULL, 0, '2026-02-24 21:44:17'),
(139, 130, 4, 3, 42.00, 1.00, '2022-08-30', '2026-09-04', 'ACTIVO', NULL, NULL, 'javier7762', NULL, 0, '2026-02-24 21:44:17'),
(140, 131, 4, 3, 23.00, 1.00, '2024-03-27', '2026-07-04', 'ACTIVO', NULL, NULL, 'Jimenam24', NULL, 0, '2026-02-24 21:44:17'),
(141, 132, 4, 3, 16.00, 1.00, '2024-11-04', '2026-07-05', 'ACTIVO', NULL, NULL, 'NinoskaClavel5', NULL, 0, '2026-02-24 21:44:17'),
(142, 133, 4, 4, 100.00, 54.00, '2024-06-04', '2026-09-04', 'ACTIVO', NULL, NULL, 'ArielD131', NULL, 0, '2026-02-24 21:44:17'),
(143, 134, 4, 3, 3.00, 1.00, '2025-12-05', '2026-09-05', 'ACTIVO', NULL, NULL, 'AlejandraT85', NULL, 0, '2026-02-24 21:44:17'),
(144, 135, 4, 4, 100.00, 54.00, '2025-09-05', '2026-09-05', 'ACTIVO', NULL, NULL, 'NAVAJASITURRE', NULL, 0, '2026-02-24 21:44:17'),
(145, 136, 4, 3, 14.00, 1.00, '2025-01-06', '2026-10-08', 'ACTIVO', NULL, NULL, 'Severiche64', NULL, 0, '2026-02-24 21:44:17'),
(146, 137, 4, 3, 41.00, 1.00, '2022-09-07', '2026-07-11', 'ACTIVO', NULL, NULL, 'Ber_Rios', NULL, 0, '2026-02-24 21:44:17'),
(147, 138, 4, 3, 33.00, 1.00, '2023-03-02', '2026-06-11', 'RECUP', NULL, NULL, 'Mgtvplusbo211', NULL, 0, '2026-02-24 21:44:17'),
(148, 139, 4, 4, 100.00, 54.00, '2024-03-19', '2026-09-08', 'ACTIVO', NULL, NULL, 'Nehemias2014', NULL, 0, '2026-02-24 21:44:17'),
(149, 140, 4, 3, 40.00, 1.00, '2022-10-22', '2026-07-09', 'ACTIVO', NULL, NULL, 'Mgtvplusbo193', NULL, 0, '2026-02-24 21:44:17'),
...
(155, 146, 4, 3, 23.00, 1.00, '2024-03-25', '2026-07-14', 'ACTIVO', NULL, NULL, 'akf75', NULL, 0, '2026-02-24 21:44:17'),
(156, 147, 4, 3, 1.00, 1.00, '2026-02-16', '2026-04-16', 'RECUP', NULL, NULL, 'Fjtvgh181', NULL, 0, '2026-02-24 21:44:17'),
(157, 148, 4, 3, 21.00, 1.00, '2024-06-15', '2026-07-21', 'ACTIVO', NULL, NULL, 'Caroline2412', NULL, 0, '2026-02-24 21:44:17'),
(158, 149, 4, 3, 10.00, 1.00, '2024-11-16', '2026-06-28', 'ACTIVO', NULL, NULL, 'pablocachi1234', NULL, 0, '2026-02-24 21:44:17'),
(159, 150, 4, 3, 14.00, 1.00, '2025-01-19', '2026-03-19', 'VENCIDO', NULL, NULL, 'Fltv7890', NULL, 1, '2026-02-24 21:44:17'),
(160, 151, 4, 3, 7.00, 1.00, '2025-08-19', '2026-05-22', 'RECUP', NULL, NULL, 'JoseA75', NULL, 0, '2026-02-24 21:44:17'),
(161, 152, 4, 3, 16.00, 1.00, '2024-11-15', '2026-05-22', 'RECUP', '2026-03-19 07:14:28', 'MENOS_2', 'vickycampos2003', NULL, 0, '2026-02-24 21:44:17'),
(162, 153, 4, 3, 18.00, 1.00, '2024-09-12', '2027-01-24', 'ACTIVO', NULL, NULL, 'AmnerCh', NULL, 0, '2026-02-24 21:44:17'),
(163, 154, 4, 3, 13.00, 1.00, '2025-02-17', '2026-03-21', 'VENCIDO', '2026-03-19 07:15:24', 'MENOS_2', 'RoldanH', NULL, 1, '2026-02-24 21:44:17'),
(164, 155, 4, 3, 43.00, 1.00, '2022-05-14', '2026-05-22', 'RECUP', NULL, NULL, 'ghostbh', NULL, 0, '2026-02-24 21:44:17'),
(165, 156, 4, 3, 37.00, 1.00, '2022-12-19', '2026-05-22', 'RECUP', NULL, NULL, 'Mgtvplusbo501', NULL, 0, '2026-02-24 21:44:17'),
...
(168, 159, 4, 3, 10.00, 1.00, '2025-05-10', '2026-07-08', 'ACTIVO', NULL, NULL, 'Brayan2945', NULL, 0, '2026-02-24 21:44:17'),
...
(174, 165, 4, 3, 14.00, 1.00, '2025-02-06', '2026-07-11', 'ACTIVO', NULL, NULL, 'Andresss43', NULL, 0, '2026-02-24 21:44:17'),
...
(186, 177, 4, 3, 42.00, 1.00, '2022-10-24', '2026-07-30', 'ACTIVO', NULL, NULL, 'AlisonSR', NULL, 0, '2026-02-24 21:44:17'),
(187, 178, 4, 3, 16.00, 1.00, '2024-11-30', '2026-08-02', 'ACTIVO', NULL, NULL, 'Elluz64', NULL, 0, '2026-02-24 21:44:17'),
(188, 179, 4, 5, 210.00, 108.00, '2025-03-05', '2026-12-16', 'ACTIVO', NULL, NULL, 'Josesitos', NULL, 0, '2026-02-24 21:44:17'),
(189, 180, 4, 5, 210.00, 108.00, '2022-11-02', '2026-12-06', 'ACTIVO', NULL, NULL, 'Edson02023', NULL, 0, '2026-02-24 21:44:17'),
(190, 181, 4, 4, 100.00, 54.00, '2022-11-03', '2026-08-09', 'ACTIVO', NULL, NULL, 'ArielG186', NULL, 0, '2026-02-24 21:44:17'),
(191, 182, 4, 3, 28.00, 1.00, '2023-09-09', '2026-08-13', 'ACTIVO', NULL, NULL, 'Andreslr', NULL, 0, '2026-02-24 21:44:17'),
(192, 183, 4, 3, 14.00, 1.00, '2025-03-15', '2026-12-15', 'ACTIVO', NULL, NULL, 'Irisabarca', NULL, 0, '2026-02-24 21:44:17'),
(193, 184, 4, 5, 210.00, 108.00, '2025-03-15', '2026-12-15', 'ACTIVO', NULL, NULL, 'Elbac', NULL, 0, '2026-02-24 21:44:17'),
(194, 185, 4, 3, 14.00, 1.00, '2025-03-07', '2026-05-16', 'RECUP', NULL, NULL, 'Dhaflujo', NULL, 0, '2026-02-24 21:44:17'),
(195, 186, 4, 5, 210.00, 108.00, '2025-10-17', '2026-12-17', 'ACTIVO', NULL, NULL, 'Mateo2945', NULL, 0, '2026-02-24 21:44:17'),
(196, 187, 4, 5, 210.00, 108.00, '2022-10-19', '2026-12-19', 'ACTIVO', NULL, NULL, 'AbastoflorF', NULL, 0, '2026-02-24 21:44:17'),
(197, 188, 4, 4, 100.00, 54.00, '2024-07-17', '2026-08-21', 'ACTIVO', NULL, NULL, 'Jessica1212', NULL, 0, '2026-02-24 21:44:17'),
(198, 189, 4, 4, 100.00, 54.00, '2025-08-20', '2026-08-21', 'ACTIVO', NULL, NULL, 'Caneltina', NULL, 0, '2026-02-24 21:44:17'),
(199, 190, 4, 4, 100.00, 54.00, '2024-05-10', '2026-08-28', 'ACTIVO', NULL, NULL, 'Rrossmar81', NULL, 0, '2026-02-24 21:44:17'),
(200, 191, 4, 3, 10.00, 1.00, '2025-06-22', '2026-05-22', 'RECUP', NULL, NULL, 'Fjtvgh174', NULL, 0, '2026-02-24 21:44:17'),
(201, 192, 4, 5, 210.00, 108.00, '2022-08-22', '2026-12-22', 'ACTIVO', NULL, NULL, 'juanaugusto75', NULL, 0, '2026-02-24 21:44:17'),
(202, 193, 4, 3, 19.00, 1.00, '2024-04-09', '2027-01-05', 'ACTIVO', NULL, NULL, 'Andres2405', NULL, 0, '2026-02-24 21:44:17'),
(203, 194, 4, 5, 210.00, 108.00, '2022-10-28', '2026-12-30', 'ACTIVO', NULL, NULL, 'Jannette', NULL, 0, '2026-02-24 21:44:17'),
(204, 195, 4, 3, 44.00, 1.00, '2022-09-30', '2026-08-30', 'ACTIVO', NULL, NULL, 'MiguelFerrufino', NULL, 0, '2026-02-24 21:44:17'),
(205, 196, 4, 3, 36.00, 1.00, '2022-11-04', '2026-12-31', 'ACTIVO', NULL, NULL, 'Harold195', NULL, 0, '2026-02-24 21:44:17'),
(206, 197, 4, 3, 39.00, 1.00, '2022-11-26', '2027-01-04', 'ACTIVO', NULL, NULL, 'MarcioG25', NULL, 0, '2026-02-24 21:44:17'),
(207, 198, 4, 3, 35.00, 1.00, '2023-07-03', '2027-06-07', 'ACTIVO', NULL, NULL, 'magisgt102', NULL, 0, '2026-02-24 21:44:17'),
(208, 199, 4, 7, 420.00, 216.00, '2024-02-07', '2027-08-07', 'ACTIVO', NULL, NULL, 'Gato4924', NULL, 0, '2026-02-24 21:44:17'),
(209, 200, 4, 5, 210.00, 108.00, '2024-09-11', '2027-01-11', 'ACTIVO', NULL, NULL, 'Taveras', NULL, 0, '2026-02-24 21:44:17'),
(210, 201, 4, 3, 31.00, 1.00, '2023-11-15', '2026-06-15', 'RECUP', NULL, NULL, 'Omarll07', NULL, 0, '2026-02-24 21:44:17'),
(211, 202, 4, 3, 14.00, 1.00, '2025-04-16', '2026-06-16', 'RECUP', NULL, NULL, 'Gabysil', NULL, 0, '2026-02-24 21:44:17'),
(212, 203, 4, 5, 210.00, 108.00, '2024-09-18', '2027-01-18', 'ACTIVO', NULL, NULL, 'camperoj1507', NULL, 0, '2026-02-24 21:44:17'),
(213, 204, 4, 5, 210.00, 108.00, '2024-06-20', '2027-01-20', 'ACTIVO', NULL, NULL, 'PachecoRiva123', NULL, 0, '2026-02-24 21:44:17'),
...
(246, 237, 4, 3, 23.00, 1.00, '2024-03-22', '2026-06-28', 'ACTIVO', NULL, NULL, 'Erick287', NULL, 0, '2026-03-02 16:34:01'),
...
(254, 245, 4, 3, 35.00, 18.00, '2026-03-13', '2026-07-13', 'ACTIVO', NULL, NULL, '04WILSON', NULL, 0, '2026-04-06 10:25:33'),
(256, 246, 4, 5, 210.00, 108.00, '2025-07-09', '2026-11-08', 'ACTIVO', NULL, NULL, 'Oscar2945', NULL, 0, '2026-04-08 12:30:59'),
(257, 247, 6, 12, 15.00, 6.00, '2026-04-21', '2026-05-21', 'RECUP', NULL, NULL, 'Fjtvgh1047', 'Importado desde 1777135850657.csv | Inicio original: 21/04/2026 22:49 | Vencimiento original: 21/05/2026 22:49 | Dias: 30', 0, '2026-04-25 13:10:50'),
...
(259, 249, 6, 12, 15.00, 6.00, '2026-04-13', '2026-05-13', 'RECUP', NULL, NULL, 'Fjtvgh1046', 'Importado desde 1777135850657.csv | Inicio original: 13/04/2026 17:43 | Vencimiento original: 13/05/2026 17:43 | Dias: 30', 0, '2026-04-25 13:10:50'),
(260, 250, 6, 12, 15.00, 6.00, '2026-04-06', '2026-05-06', 'RECUP', NULL, NULL, 'Fjtvgh1045', 'Importado desde 1777135850657.csv | Inicio original: 06/04/2026 16:47 | Vencimiento original: 06/05/2026 16:47 | Dias: 30', 0, '2026-04-25 13:10:50'),
(261, 251, 6, 12, 15.00, 6.00, '2026-04-03', '2026-05-03', 'RECUP', NULL, NULL, 'Fjtvgh1044', 'Importado desde 1777135850657.csv | Inicio original: 03/04/2026 21:35 | Vencimiento original: 03/05/2026 21:35 | Dias: 30', 0, '2026-04-25 13:10:50'),
(262, 252, 6, 12, 15.00, 6.00, '2026-04-03', '2026-05-03', 'RECUP', NULL, NULL, 'Fjtvgh1043', 'Importado desde 1777135850657.csv | Inicio original: 03/04/2026 13:10 | Vencimiento original: 03/05/2026 13:10 | Dias: 30', 0, '2026-04-25 13:10:50'),
(263, 253, 6, 12, 15.00, 6.00, '2026-03-31', '2026-05-01', 'RECUP', NULL, NULL, 'Fjtvgh1042', 'Importado desde 1777135850657.csv | Inicio original: 31/03/2026 20:13 | Vencimiento original: 01/05/2026 20:13 | Dias: 31', 0, '2026-04-25 13:10:50'),
...
(267, 257, 6, 12, 15.00, 6.00, '2026-03-26', '2026-04-26', 'RECUP', NULL, NULL, 'Fjtvgh1041', 'Importado desde 1777135850657.csv | Inicio original: 26/03/2026 17:06 | Vencimiento original: 26/04/2026 17:06 | Dias: 31', 0, '2026-04-25 13:10:50'),
(268, 258, 6, 12, 15.00, 6.00, '2026-03-26', '2026-04-26', 'RECUP', NULL, NULL, 'Fjtvgh1040', 'Importado desde 1777135850657.csv | Inicio original: 26/03/2026 14:36 | Vencimiento original: 26/04/2026 14:36 | Dias: 31', 0, '2026-04-25 13:10:50'),
(269, 259, 6, 13, 40.00, 18.00, '2026-03-25', '2026-06-25', 'VENCIDO', NULL, NULL, 'Fjtvcg1027', 'Importado desde 1777135850657.csv | Inicio original: 25/03/2026 20:43 | Vencimiento original: 25/06/2026 20:43 | Dias: 92', 0, '2026-04-25 13:10:50'),
(270, 260, 6, 13, 40.00, 18.00, '2026-03-25', '2026-06-25', 'VENCIDO', NULL, NULL, 'Fjtvcg1026', 'Importado desde 1777135850657.csv | Inicio original: 25/03/2026 23:35 | Vencimiento original: 25/06/2026 23:35 | Dias: 92', 0, '2026-04-25 13:10:50'),
(271, 261, 6, 13, 40.00, 18.00, '2026-03-15', '2026-06-15', 'RECUP', NULL, NULL, 'Fjtvcg1025', 'Importado desde 1777135850657.csv | Inicio original: 15/03/2026 20:02 | Vencimiento original: 15/06/2026 20:02 | Dias: 92', 0, '2026-04-25 13:10:50'),
(272, 262, 6, 13, 40.00, 18.00, '2026-03-11', '2026-06-11', 'RECUP', NULL, NULL, 'Fjtvcg1024', 'Importado desde 1777135850657.csv | Inicio original: 11/03/2026 19:27 | Vencimiento original: 11/06/2026 19:27 | Dias: 92', 0, '2026-04-25 13:10:50'),
(273, 263, 6, 13, 40.00, 18.00, '2026-03-03', '2026-06-03', 'RECUP', NULL, NULL, 'Fjtvcg1023', 'Importado desde 1777135850657.csv | Inicio original: 03/03/2026 17:48 | Vencimiento original: 03/06/2026 17:48 | Dias: 92', 0, '2026-04-25 13:10:50'),
(274, 264, 6, 13, 40.00, 18.00, '2026-02-25', '2026-05-25', 'RECUP', NULL, NULL, 'Fjtvcg1022', 'Importado desde 1777135850657.csv | Inicio original: 25/02/2026 23:45 | Vencimiento original: 25/05/2026 23:45 | Dias: 89', 0, '2026-04-25 13:10:50'),
(275, 265, 6, 13, 40.00, 18.00, '2026-02-22', '2026-05-22', 'RECUP', NULL, NULL, 'Fjtvcg1021', 'Importado desde 1777135850657.csv | Inicio original: 22/02/2026 22:10 | Vencimiento original: 22/05/2026 22:10 | Dias: 89', 0, '2026-04-25 13:10:50'),
(276, 266, 6, 13, 40.00, 18.00, '2026-02-18', '2026-05-18', 'RECUP', NULL, NULL, 'Fjtvcg1020', 'Importado desde 1777135850657.csv | Inicio original: 18/02/2026 23:39 | Vencimiento original: 18/05/2026 23:39 | Dias: 89', 0, '2026-04-25 13:10:50'),
(277, 267, 6, 13, 40.00, 18.00, '2026-02-02', '2026-05-02', 'RECUP', NULL, NULL, 'Fjtvcg1019', 'Importado desde 1777135850657.csv | Inicio original: 02/02/2026 17:55 | Vencimiento original: 02/05/2026 17:55 | Dias: 89', 0, '2026-04-25 13:10:50'),
(278, 268, 6, 13, 40.00, 18.00, '2026-01-31', '2026-05-01', 'RECUP', NULL, NULL, 'Fjtvcg1018', 'Importado desde 1777135850657.csv | Inicio original: 31/01/2026 0:22 | Vencimiento original: 01/05/2026 0:22 | Dias: 90', 0, '2026-04-25 13:10:50'),
(279, 269, 6, 13, 40.00, 18.00, '2026-01-26', '2026-04-26', 'RECUP', NULL, NULL, 'Fjtvcg1017', 'Importado desde 1777135850657.csv | Inicio original: 26/01/2026 12:03 | Vencimiento original: 26/04/2026 12:03 | Dias: 90', 0, '2026-04-25 13:10:50'),
(280, 270, 6, 14, 90.00, 36.00, '2025-04-18', '2026-08-05', 'ACTIVO', NULL, NULL, 'Fjtvcg957', 'Importado desde 1777135850657.csv | Inicio original: 18/04/2025 14:33 | Vencimiento original: 28/04/2026 21:31 | Dias: 375', 0, '2026-04-25 13:10:50'),
...
(285, 275, 4, 4, 100.00, 54.00, '2026-03-26', '2026-08-02', 'ACTIVO', NULL, NULL, 'Fjtvgh185', 'Importado desde us cc.csv | Inicio original: 2026-03-26 21:59:09 | Vencimiento original: 2026-04-26 21:59:09 | Dias: 31', 0, '2026-04-25 13:26:53'),
(286, 276, 4, 4, 100.00, 54.00, '2026-03-19', '2026-06-19', 'RECUP', NULL, NULL, 'Fjtvgh184', 'Importado desde us cc.csv | Inicio original: 2026-03-19 17:22:34 | Vencimiento original: 2026-06-19 17:22:34 | Dias: 92', 0, '2026-04-25 13:26:53'),
(287, 277, 4, 4, 100.00, 54.00, '2026-03-18', '2026-06-18', 'RECUP', NULL, NULL, 'Fjtvgh183', 'Importado desde us cc.csv | Inicio original: 2026-03-18 01:58:33 | Vencimiento original: 2026-06-18 01:58:33 | Dias: 92', 0, '2026-04-25 13:26:53'),
(288, 278, 6, 12, 15.00, 6.00, '2026-04-25', '2026-05-25', 'RECUP', NULL, NULL, 'Fjtvgh1048', 'Importado desde cdsp.xlsx.csv | Inicio original: 25/04/2026 | Vencimiento original: 25/05/2026 21:47:03 | Dias: 30', 0, '2026-05-15 10:55:56'),
(289, 279, 6, 12, 15.00, 6.00, '2026-04-27', '2026-05-27', 'RECUP', NULL, NULL, 'Fjtvgh1049', 'Importado desde cdsp.xlsx.csv | Inicio original: 27/04/2026 | Vencimiento original: 27/05/2026 01:31:19 | Dias: 30', 0, '2026-05-15 10:55:56'),
(290, 280, 6, 12, 15.00, 6.00, '2026-05-03', '2026-06-03', 'RECUP', NULL, NULL, 'Fjtvgh1050', 'Importado desde cdsp.xlsx.csv | Inicio original: 03/05/2026 | Vencimiento original: 03/06/2026 22:55:42 | Dias: 31', 0, '2026-05-15 10:55:56'),
(291, 281, 6, 12, 15.00, 6.00, '2026-05-05', '2026-06-05', 'RECUP', NULL, NULL, 'Fjtvgh1051', 'Importado desde cdsp.xlsx.csv | Inicio original: 05/05/2026 | Vencimiento original: 05/06/2026 16:43:15 | Dias: 31', 0, '2026-05-15 10:55:56'),
(292, 282, 6, 12, 15.00, 6.00, '2026-05-06', '2026-06-06', 'RECUP', NULL, NULL, 'Fjtvgh1052', 'Importado desde cdsp.xlsx.csv | Inicio original: 06/05/2026 | Vencimiento original: 06/06/2026 18:51:12 | Dias: 31', 0, '2026-05-15 10:55:56'),
(293, 283, 6, 12, 15.00, 6.00, '2026-05-09', '2026-06-09', 'RECUP', NULL, NULL, 'Fjtvgh1053', 'Importado desde cdsp.xlsx.csv | Inicio original: 09/05/2026 | Vencimiento original: 09/06/2026 18:27:31 | Dias: 31', 0, '2026-05-15 10:55:56'),
(294, 284, 6, 13, 40.00, 18.00, '2026-04-26', '2026-07-26', 'ACTIVO', NULL, NULL, 'Fjtvcg1032', 'Importado desde cdsp.xlsx.csv | Inicio original: 26/04/2026 | Vencimiento original: 26/07/2026 13:02:47 | Dias: 91', 0, '2026-05-15 10:55:56'),
(295, 285, 6, 13, 40.00, 18.00, '2026-04-27', '2026-07-27', 'ACTIVO', NULL, NULL, 'Fjtvcg1033', 'Importado desde cdsp.xlsx.csv | Inicio original: 27/04/2026 | Vencimiento original: 27/07/2026 18:35:26 | Dias: 91', 0, '2026-05-15 10:55:56'),
(296, 286, 6, 13, 40.00, 18.00, '2026-04-30', '2026-07-30', 'ACTIVO', NULL, NULL, 'Fjtvcg1034', 'Importado desde cdsp.xlsx.csv | Inicio original: 30/04/2026 | Vencimiento original: 30/07/2026 00:23:05 | Dias: 91', 0, '2026-05-15 10:55:56'),
(297, 287, 6, 13, 40.00, 18.00, '2026-05-04', '2026-08-04', 'ACTIVO', NULL, NULL, 'Fjtvcg1035', 'Importado desde cdsp.xlsx.csv | Inicio original: 04/05/2026 | Vencimiento original: 04/08/2026 00:26:28 | Dias: 92', 0, '2026-05-15 10:55:56'),
(298, 288, 6, 13, 40.00, 18.00, '2026-05-06', '2026-08-06', 'ACTIVO', NULL, NULL, 'Fjtvcg1036', 'Importado desde cdsp.xlsx.csv | Inicio original: 06/05/2026 | Vencimiento original: 06/08/2026 20:08:42 | Dias: 92', 0, '2026-05-15 10:55:56');
...
--
-- Indices de la tabla `backup_vencimientos_20260515_flujotv_cc`
--
ALTER TABLE `backup_vencimientos_20260515_flujotv_cc`
  ADD PRIMARY KEY (`backup_id`);

--
-- Indices de la tabla `backup_vencimientos_20260515_flujotv_disp`
--
ALTER TABLE `backup_vencimientos_20260515_flujotv_disp`
  ADD PRIMARY KEY (`backup_id`);
...
--
-- AUTO_INCREMENT de la tabla `backup_vencimientos_20260515_flujotv_cc`
--
ALTER TABLE `backup_vencimientos_20260515_flujotv_cc`
  MODIFY `backup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `backup_vencimientos_20260515_flujotv_disp`
--
ALTER TABLE `backup_vencimientos_20260515_flujotv_disp`
